...
echo '<script type="text/javascript">
         ...
         $("#faucetform").submit(function() {
            $.ajax({
               beforeSend: function (request) {
                  $("#faucetresponce").html("The form is processing your request. Please wait patiently.");
               },
               data: $(this).serialize(),
      ...
      <table style="width: 100%; height: 100px;">
         <tr>
            <td align="center">
               ...
               <table>
                  <tr>
                     <td nowrap>Nanotoken Address:</td>
                     <td style="padding-left: 10px;" nowrap><input type="text" name="setaddr" id="setaddr" placeholder="Ma4cSuXrSnL1gU8YjTrtsotBVK4kNQxixk" onclick="setaddr()" onkeyup="setaddr()" onkeydown="setaddr()" onchange="setaddr()" style="width: 400px; height: 22px;"></td>
                  </tr>
               </table>
            </td>
         </tr>
      ...
      <div style="border-top: 4px solid #828790; height: 125px;">
         <div class="coin_box">
            <div id="coina" class="coin"><input type="submit" name="submit" value="" class="targetnan"></div>
         </div>
         <div class="coin_box">
            <div id="coinb" class="coin"><input type="submit" name="submit" value="" class="targetnan"></div>
         </div>
         <div class="coin_box">
            <div id="coinc" class="coin"><input type="submit" name="submit" value="" class="targetnan"></div>
         </div>
      </div>
      </form>
