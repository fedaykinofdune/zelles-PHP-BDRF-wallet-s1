               ...
               if($num_rows==0) {
                  ...
                  if($num_rows==0) {
                     ...
                     if($num_rows==0) {
                        ...
                        $onloader = 'Success, Megacoins sent. '.$send_message;
                     } else {
                        $onloader = 'You already requested Megacoins today. Try again tomorrow.';
                     }
                  } else {
                     $onloader = 'You already requested Megacoins today. Try again tomorrow.';
                  }
...
echo '<center>'.$onloader.'</center><div style="height: 20px;"></div>';
?>